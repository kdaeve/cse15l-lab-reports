...
University usually provides specific course accounts for student. For this step, we'll use a command which calls <mark>ssh</mark>  

For Windows:  
Before we get started, you need to install OpenSSH to connect your server or other computers. To install OpenSSH, please following Microsoft Documentation website https://docs.microsoft.com/en-us/windows-server/administration/openssh/openssh_install_firstuse and following this instruction to install it.  
